        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="space-y-6">
            ...
            <p className="text-xl text-teal-100 max-w-4xl mx-auto leading-relaxed">
              Modern IT infrastructure that streamlines bureaucratic processes and enhances citizen service delivery through secure, scalable digital platforms.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {['Digital Identity', 'Process Automation', 'Citizen Portals', 'Data Analytics', 'Mobile Services'].map((feature, index) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how we can modernize your agency's technology infrastructure.
          </p>
