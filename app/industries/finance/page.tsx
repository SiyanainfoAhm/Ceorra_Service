  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(13, 148, 136, 0.9), rgba(6, 182, 212, 0.9)), url('https://readdy.ai/api/search-image?query=Government%20financial%20operations%20center%20with%20budget%20analytics%20dashboard%2C%20fiscal%20transparency%20platform%2C%20public%20accounting%20technology%2C%20teal%20interface%20design%2C%20financial%20compliance%20monitoring%20systems%2C%20treasury%20management%20displays&width=1920&height=800&seq=finance-detail-hero&orientation=landscape')`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="space-y-6">
            ...
            <p className="text-xl text-teal-100 max-w-4xl mx-auto leading-relaxed">
              Financial management systems that ensure transparency, automate budget processes, and provide real-time insights into public spending with advanced analytics for better fiscal planning.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {['Budget Planning', 'Expense Tracking', 'Audit Tools', 'Public Dashboards', 'Compliance Reporting'].map((feature, index) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how we can enhance your public finance operations with transparency and efficiency.
          </p>
