  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(13, 148, 136, 0.9), rgba(6, 182, 212, 0.9)), url('https://readdy.ai/api/search-image?query=Digital%20education%20technology%20center%20with%20online%20learning%20platforms%2C%20educational%20analytics%20dashboard%2C%20modern%20classroom%20technology%2C%20teal%20interface%20elements%2C%20e-learning%20infrastructure%2C%20student%20engagement%20systems&width=1920&height=800&seq=education-detail-hero&orientation=landscape')`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="space-y-6">
            ...
            <p className="text-xl text-teal-100 max-w-4xl mx-auto leading-relaxed">
              Learning management platforms that enhance educational delivery, support remote learning, and provide analytics for institutional improvement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {['LMS Platforms', 'Virtual Classrooms', 'Progress Analytics', 'Mobile Learning', 'Assessment Tools'].map((feature, index) => (
              <div key={index} className="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300">
                <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="ri-school-line text-teal-600 text-xl"></i>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">
            Ready to Transform Educational Delivery?
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how digital learning platforms can enhance educational outcomes and accessibility.
          </p>
